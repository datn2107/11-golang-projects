...
import (
	...
	"github.com/datn2107/go-serverless/pkg/user"
)

type ErrorBody struct {
	ErrorMsg *string `jsong:"error,omitempty"`
}
...
func UnhandleMethod() (*events.APIGatewayProxyResponse, error) {
	return apiResponse(http.StatusMethodNotAllowed, ErrorBody{ErrorMsg: aws.String(ErrorMethodNotAllowed)})
}
